...
library(car)
#-----------------------
setwd ("C:/rtools40/My Data/IIT Kanpur R Projects/Data Project-2")
getwd()
#-----------------------
...
#-----------------------
for_vif=lm(store~.-Id-sales0-sales2-sales3-sales1,data=train_75) # Logistic Regression
...
auc(roccurve)
#-----------------------
DT= tree(as.factor(store)~.-Id,data=train_75) # Decision Tree
...
myauc=0
#-----------------------
## It takes almost hours to run in i7 Laptop
...
write.csv(test.score_final,'Dr_P_Adhikary_P2_part2.csv',row.names = F)
#-----------------------
